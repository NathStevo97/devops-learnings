...
1. Implementing security measures: Provide sufficient guarantees of technical and organisation measures
2. Use of subprocessors: can only be done with the controller's prior consent
3. Contracts with Controller - should detail the following:
4. Subject matter
5. Type of data / subjects considered
6. Nature and purpose of data usage
7. Obligations of each party
8. RACI Matrix is a useful tool in this context

- Model Clauses: Contracts with technical addendums
- Plenty of templates are available online.

1. Process only data in scope - the processor should have records of processing activity for evidence and review in the event of an audit.
